...
export const WelComeUzbekistan = () => {
  const t = useTranslations("");
  const [isClient, setIsClient] = useState(false);

  const videoUrl = "https://youtu.be/0ZlLoAbFZ64?feature=shared"; 
  const posterUrl = "https://ucarecdn.com/cc265554-c0d2-4a0f-a22c-f8b5bac57aa6/-/preview/1000x625/"; // O'zingizga mos poster URL'si
  ...
  return (
    <section className="px-[20px] lg:px-[120px] pb-[60px] lg:pb-[160px]">
      <p className="title-text mb-4 lg:mb-6">{t("welcome_uzbekistan")}</p>
